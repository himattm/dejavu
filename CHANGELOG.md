...
- CI: the `compose-compat` BOM matrix and the Android instrumented BOM gates now cover only supported runtimes at or above the floor — 2026.01.01, 2026.03.01, and 2026.05.00.
